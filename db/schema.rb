...
ActiveRecord::Schema.define(version: 20171123004642) do
  ...
  create_table "topics", force: :cascade do |t|
    ...
    t.integer "search_unit"
    t.index ["name", "user_id", "search_unit"], name: "index_topics_on_name_and_user_id_and_search_unit", unique: true
  end
